...
extension ClubQueryFilter on QueryBuilder<Club, Club, QFilterCondition> {
  ...
  QueryBuilder<Club, Club, QAfterFilterCondition> nameEqualTo(
    String value, {
  ...
  QueryBuilder<Club, Club, QAfterFilterCondition> nameGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Club, Club, QAfterFilterCondition> nameLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Club, Club, QAfterFilterCondition> nameBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Club, Club, QAfterFilterCondition> nameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Club, Club, QAfterFilterCondition> nameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Club, Club, QAfterFilterCondition> nameContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Club, Club, QAfterFilterCondition> nameMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Club, Club, QAfterFilterCondition> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'name',
        value: '',
  ...
  QueryBuilder<Club, Club, QAfterFilterCondition> nameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'name',
        value: '',
...
extension ClubQuerySortBy on QueryBuilder<Club, Club, QSortBy> {
  QueryBuilder<Club, Club, QAfterSortBy> sortByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<Club, Club, QAfterSortBy> sortByNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ClubQuerySortThenBy on QueryBuilder<Club, Club, QSortThenBy> {
  ...
  QueryBuilder<Club, Club, QAfterSortBy> thenByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<Club, Club, QAfterSortBy> thenByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }
...
extension ClubQueryWhereDistinct on QueryBuilder<Club, Club, QDistinct> {
  QueryBuilder<Club, Club, QDistinct> distinctByName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ClubQueryProperty on QueryBuilder<Club, Club, QQueryProperty> {
  ...
  QueryBuilder<Club, String, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
